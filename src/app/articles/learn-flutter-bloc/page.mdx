...
import learnFlutterBloc0 from './learn-flutter-bloc_0.png'
import learnFlutterBloc1 from './learn-flutter-bloc_1.png'

export const article = {
  author: 'Jimmy Xu',
  date: '2023-08-09',
  title: '学习 Flutter Bloc',
  description: '通过实践学习 Flutter 中的 Bloc 状态管理模式。',
  tags: ['Flutter', 'BLOC'],
}
...
<Image src={learnFlutterBloc0} alt="" />

### [Bloc](https://bloclibrary.dev/#/zh-cn/coreconcepts?id=bloc)

<Image src={learnFlutterBloc1} alt="" />
